...
function custom_woocommerce_default_address_fields($fields) {
    ...
    $fields['address_1']['placeholder'] = 'Entrez votre adresse';

    $fields['address_2']['label'] = 'Complément d\'adresse (optionnel)';
    $fields['address_2']['placeholder'] = 'Appartement, suite, unité, etc. (optionnel)';

    $fields['city']['label'] = 'Ville';
    $fields['city']['placeholder'] = 'Entrez votre ville';

    $fields['state']['label'] = 'État/Région';
    $fields['state']['placeholder'] = 'Entrez votre région';

    $fields['postcode']['label'] = 'Code postal';
    $fields['postcode']['placeholder'] = 'Entrez votre code postal';

    return $fields;
}

/**
 * Removing company field from billing form.
 */
