        ...
        <ul class="wc_payment_methods payment_methods methods">
            <?php
				if ( ! empty( $available_gateways ) ) {
					...
					echo '<li>';
					wc_print_notice( apply_filters( 'woocommerce_no_available_payment_methods_message', esc_html__( "Désolé, il semble qu'aucun moyen de paiement ne soit disponible pour votre région. Veuillez nous contacter si vous avez besoin d'aide ou souhaitez prendre d'autres dispositions.", 'woocommerce' ) ), 'notice' ); // phpcs:ignore WooCommerce.Commenting.CommentHooks.MissingHookComment
					echo '</li>';
				}
				?>
        </ul>
