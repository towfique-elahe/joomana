        ...
        <div id="invoice">
            ...
            <div class="address-section">
                <table class="table bill-to-table">
                    <tr>
                        <th colspan="2">Détails des parents</th>
                    </tr>
                    <tr>
                        <th>Nom</th>
                        <td>
                    ...
                    <tr>
                        <th>Email</th>
                        <td>
                            <?= esc_html($parent->email) ?>
                        </td>
                    </tr>
                    <tr>
                        <th>Phone</th>
                        <td>
                            <?= esc_html($parent->phone) ?>
                        </td>
                    </tr>
                    <tr>
                        <th>Address</th>
                        <td>
                            <?= esc_html($parent->address) ?>
                        </td>
                    </tr>
                    <tr>
                        <th>City</th>
                        <td>
                            <?= esc_html($parent->city) ?>
                        </td>
                    </tr>
                    <tr>
                        <th>Zip Code</th>
                        <td>
                            <?= esc_html($parent->zipcode) ?>
                        </td>
                    </tr>
                    <tr>
                        <th>Country</th>
                        <td>
                            <?= esc_html($parent->country) ?>
                        </td>
                    </tr>
                </table>
            </div>
