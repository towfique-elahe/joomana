                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" id="duration" name="duration"
                                value="<?php echo esc_attr($course->duration); ?>" placeholder="1h 30m" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="date" id="start_date" name="start_date"
                                value="<?php echo esc_attr($course->start_date); ?>" required>
                        </div>
                        <div class="col">
                            <label for="end_date">Date de fin <span class="required">*</span></label>
                            <input type="date" name="end_date" id="end_date"
                                value="<?php echo esc_attr($course->end_date); ?>" required>
                        </div>
                    </div>
