...
/* Template Name: Admin | Student Invoice */
                    ...
                    <tr>
                        ...
                        <td>
                            <h3 class="customer-name">
                                <?= esc_html($student->first_name) . ' ' . esc_html($student->last_name) ?>
                            </h3>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?= esc_html(date('d M, Y', strtotime($student->date_of_birth))) ?>
                        </td>
                    </tr>
                    <tr>
                        <th>Genre</th>
                        <td>
                            <?= esc_html($student->gender) ?>
                        </td>
                    </tr>
                </table>
            </div>
