...
<head>
    ...
    <title>
        <?php
            if (!empty($pageTitle)) {
                echo esc_html($pageTitle) . ' | ' . get_bloginfo('name') . " Portail étudiant";
            } else {
                echo get_bloginfo('name') . " Portail étudiant";
            }
        ?>
    </title>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/css/student-portal.css'; ?>">
